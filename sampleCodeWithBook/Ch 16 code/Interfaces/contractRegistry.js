...
ReliableJavaScript.contractRegistry = function () {
    ...
    return {
        ...
        messages: {
            ...
            namesMustBeStringArray: 'The contractNames argument must be an array of strings or undefineds',
        ...
        getMessageForFailedContract: function getMessageForFailedContract(contractName, obj) {
